...
namespace IntaxExterno.Infra.Data.Migrations
{
    ...
    [Migration("20251221030035_atualiz insumos ")]
    partial class atualizinsumos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.InsumosResultado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DescricaoVerba")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.Oportunidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.OportunidadeTeses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.SpedContabilI050", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.SpedContribuicoes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.SpedFiscal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntaxExterno.Domain.Entities.Oportunidade", b =>
                {
                    b.Navigation("OportunidadeTeses");

                    b.Navigation("ResultadosExclusaoIcms");

                    b.Navigation("SpedContribuicoes");

                    b.Navigation("SpedFiscais");
                });
