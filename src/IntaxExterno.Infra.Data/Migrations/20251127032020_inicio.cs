        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pix = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parceiro_CPF",
                table: "Parceiros",
                column: "CPF",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Parceiro_Email",
                table: "Parceiros",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_Parceiro_IsActive",
                table: "Parceiros",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_Parceiro_UID",
                table: "Parceiros",
                column: "UID",
                unique: true);
