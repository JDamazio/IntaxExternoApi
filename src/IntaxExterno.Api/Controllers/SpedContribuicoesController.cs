...
public class SpedContribuicoesController : ControllerBase
{
    private readonly ISpedContribuicoesService _service;
    private readonly string _token;

    public SpedContribuicoesController(ISpedContribuicoesService service, IHttpContextAccessor httpContextAccessor)
    {
        _service = service;
    ...
    /// <summary>
    /// Cria múltiplos registros de SPED Contribuições de uma vez
    /// </summary>
    [HttpPost("batch")]
    public async Task<ActionResult> CreateMany([FromBody] List<SpedContribuicoesPostDto> dtos)
    {
    ...
    /// <summary>
    /// Obtém todos os registros de SPED Contribuições de uma Oportunidade
    /// </summary>
    ...
    /// <summary>
    /// Deleta todos os registros de SPED Contribuições de uma Oportunidade
    /// </summary>
